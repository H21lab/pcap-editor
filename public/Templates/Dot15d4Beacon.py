"""Dot15d4Beacon template using proper Scapy encoding."""
import binascii
import copy
from scapy.layers.dot15d4 import Dot15d4Beacon
...
def source_code(val, payload_var=None):
    ...
    ctor = f"Dot15d4Beacon({', '.join(fields)})"
    if payload_var:
