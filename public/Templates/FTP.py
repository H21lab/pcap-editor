"""
FTP (File Transfer Protocol) template.
Parses FTP control channel commands and responses.
"""
import binascii
import copy
...
def decode(hex_data, **kwargs):
    """Decode FTP control message from hex."""
...
def encode(val):
    """Encode FTP message back to hex."""
